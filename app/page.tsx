...
function History({ items, site, filter, onFilter, onContinue, onRequestDelete }: { items: MocCase[]; site: Site | null; filter: string; onFilter: (v: string) => void; onContinue: (c: MocCase) => void; onRequestDelete: (ids: string[]) => void }) {
  const [selectedCase, setSelectedCase] = useState<MocCase | null>(null);
